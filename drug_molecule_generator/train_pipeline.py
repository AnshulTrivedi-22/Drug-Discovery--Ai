...
from drug_molecule_generator.preprocessing.data_management import load_dataset,save_model,load_nn_model
import drug_molecule_generator.preprocessing.preprocessors as pp
import drug_molecule_generator.pipeline as pl


loaded_model_name = "enc_dec_drug_molecule_gen.keras"
...
def run_training():
    ...
    history = drug_discovery_model.fit(
        training_data_generator(100,1),
        epochs=1,
        steps_per_epoch=100,
        validation_data=cv_data_generator(171,1),
        validation_steps=18)
...
if __name__=="__main__":
    ...
    print("Trained\n")
    loaded_model= load_nn_model(loaded_model_name)
    mlflow.set_experiment("drug_molecule_discovery")
    mlflow_logs(loaded_model,model_history,"enc_dec_drug_molecule_gen.keras")
