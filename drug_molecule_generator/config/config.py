...
TEST_FILE = "test.csv"
BASE_VOCABULARY = ['6','p','4','7','r','[','o','+','H','\\','s','#','C','<','/','%','N','0','=','.','c','3','5','S','l','1','B','I','\n','(','O','-',')',']','8','P','9','n','F','2']

INPUT_VOCABULARY = ['','[UNK]','6','p','4','7','r','[','o','+','H','\\','s','#','C','<','/','%','N','0','=','.','c','3','5','S','l','1','B','I','\n','(','O','-',')',']','8','P','9','n','F','2']

OUTPUT_VOCABULARY = ['','[UNK]','6','p','4','7','r','[','o','+','H','\\','s','#','C','<','/','%','N','0','=','.','c','3','5','S','l','1','B','I','\n','(','O','-',')',']','8','P','9','n','F','2']
